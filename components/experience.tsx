...
const experiences = [
  {
    ...
    company: "Visual Vibe",
    duration: "11 May 2025 – 15 March 2026",
    description:
      "Worked as a MERN Stack Developer at Visual Vibe, contributing to web application development and real-world client and company projects. Worked across frontend and backend development, REST APIs, database management, debugging, testing, performance optimization, and deployment-related activities.",
    achievements: [
      ...
      "Worked with MongoDB for database management and application data",
      "Performed debugging, testing, and performance optimization",
      "Worked collaboratively with the development team to understand project requirements",
      "Implemented technical solutions and completed assigned tasks within timelines",
      "Gained practical experience in REST API development and frontend-backend integration",
      "Worked with version control and deployment-related development workflows",
    ],
    technologies: [
      "MongoDB",
      "Express.js",
    ...
    certificateTitle: "Experience Letter",
    certificateImage: "/Dinesh_Experience_letter0.jpg",
    certificateDescription:
      "Experience letter issued by Visual Vibe for the successful completion of the MERN Stack Developer employment period.",
  },

  {
    ...
    certificateImage: "/bluestock-certificate.jpg",
    certificateDescription:
      "Certificate awarded by Bluestock Fintech for successfully completing the Software Development Engineer (SDE) Internship Program.",
  },
];
  ...
  return (
    <section id="experience" className="py-20">
      ...
      >
        ...
        <p className="text-muted-foreground mb-10">
          Professional experience and industry exposure gained through
          full-stack development, internships, and real-world software
          development.
        </p>
                ...
                <div className="mt-8">
                  ...
                  <div className="overflow-hidden rounded-xl border group">
                    <Image
                      ...
                      alt={`${experience.company} ${experience.certificateTitle}`}
                      width={1200}
                      height={850}
                      className="w-full transition-transform duration-300 group-hover:scale-[1.02]"
                    />
                  ...
                  <p className="text-sm text-muted-foreground mt-3">
                    {experience.certificateDescription}
                  </p>
                </div>
              </div>
            </motion.div>
